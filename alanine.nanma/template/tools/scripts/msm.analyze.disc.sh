...
rm -f current.name
echo "." > current.name
mycommand="$msm_dir/calculate.commitor --input-largest-set $target_dir/largestSet.dih --num-bin $msm_dih_nbin --input-cluster-map $target_dir/cluster.map.out --input-traj-dir current.name --input-disc-traj traj.out --output-fw $target_dir/commitor.fw.msm.out --output-bw $target_dir/commitor.bw.msm.out"
...
mycommand="$msm_dir/calculate.steady.dist --input-largest-set $target_dir/largestSet.dih --num-bin $msm_dih_nbin --input-traj-dir current.name --input-disc-traj traj.out --output $target_dir/steady.dist.msm.out"
