...
MDRUN=`which mdrun_ompi`

echo "USING $MPIRUN and $MDRUN On $HOSTNAME" 
./min.sh xa  MIN0 $GROMPP $MPIRUN $MDRUN 
./gmx_equi.sh 300 xa $GROMPP $MPIRUN $MDRUN $TPBCONV
./gmx_sim.sh 300 1 6 xa $GROMPP $TPBCONV $MPIRUN $MDRUN
