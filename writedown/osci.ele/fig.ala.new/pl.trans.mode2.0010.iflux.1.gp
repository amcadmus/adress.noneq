...
set out 'fig-trans-mode2-0010-iflux-1.eps'
...
pl 'ext.mode2.010.Ex.01.00.shift0.t1000ps/set/meta.flux.inte.out' u 1:($2*1) ls 11 w l not, '' u 1:($3*1) ls 12 w l not, '' u 1:($4*1) ls 13 w l not, '' u 1:($5*1) ls 14 w l not, '' u 1:($6*1) ls 15 w l not
