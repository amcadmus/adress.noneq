set label 'Q_{J,{/Symbol a}_L}, T_P = 200 ps' at 400,0.4
set lmargin 4.5
set rmargin 2
unset tmargin
unset bmargin
...
set out 'fig-trans-mode2-0200-iflux-5.eps'
...
set tmargin 1.0
set bmargin 2.5
set label 't [ ps ]' at 2400,-0.36

pl 'ext.mode2.200.Ex.01.00.shift0.t6400ps/set/meta.flux.inte.out' u 1:22 ls 11 w l not, '' u 1:23 ls 12 w l not, '' u 1:24 ls 13 w l not, '' u 1:25 ls 14 w l not, '' u 1:26 ls 15 w l not
