...
pl 'ext.mode2.010.Ex.01.00.shift0.t1000ps/set/meta.flux.inte.out' u 1:($2*2) ls 11 w l not, '' u 1:($3*2) ls 12 w l not, '' u 1:($4*2) ls 13 w l not, '' u 1:($5*2) ls 14 w l not, '' u 1:($6*2) ls 15 w l not
