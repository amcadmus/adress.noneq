...
set out 'fig-trans-100-iflux-1.eps'
set multiplot
set size 0.4,1
...
set mxtics 5
set xrange [0:100]
pl 'ext.mode1.100.Ex.01.00.t1200ps/set/meta.flux.inte.out' u 1:2 ls 11 w l not, '' u 1:3 ls 12 w l not, '' u 1:4 ls 13 w l not, '' u 1:5 ls 14 w l not, '' u 1:6 ls 15 w l not
