...
pl \
'ext.mode1.010.Ex.01.00.t1000ps.recheck/set/metastable.out'		u 1:2 every 48 w l ls 11 t 't_{init}=10 ps', '' u 1:3 every 48 w l ls 12 not, '' u 1:4 every 48 w l ls 13  not, '' u 1:5 every 48 w l ls 14  not, '' u 1:6 every 48 w l ls 15 not
