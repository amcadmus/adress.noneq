...
set out 'fig-trans-100-bwd-2.eps'
set multiplot
set size 0.4,1
set yrange [0:1]
set mytics 2
...
set mxtics 5
set xrange [0:100]
pl 'ext.mode1.100.Ex.01.00.t1200ps/set/meta.corr.bw.out' u 1:7 ls 11 w l not, '' u 1:8 ls 12 w l not, '' u 1:9 ls 13 w l not, '' u 1:10 ls 14 w l not, '' u 1:11 ls 15 w l not
