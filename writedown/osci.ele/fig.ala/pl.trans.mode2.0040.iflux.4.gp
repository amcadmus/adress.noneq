set label 'Q_{J,B_2}, T_P = 40 ps' at 50,1.0
set lmargin 4.5
set rmargin 2
unset tmargin
unset bmargin
...
set out 'fig-trans-mode2-0040-iflux-4.eps'
...
pl 'ext.mode2.040.Ex.01.00.shift0.t1600ps/set/meta.flux.inte.out' u 1:17 ls 11 w l not, '' u 1:18 ls 12 w l not, '' u 1:19 ls 13 w l not, '' u 1:20 ls 14 w l not, '' u 1:21 ls 15 w l not
