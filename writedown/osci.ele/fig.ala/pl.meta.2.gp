...
'ext.mode1.010.Ex.01.00.t1000ps.nve/set/metastable.out'		u 1:2 every 4 w l ls 31 not, '' u 1:3 every 4 w l ls 32 not, '' u 1:4 every 4 w l ls 33  not, '' u 1:5 every 4 w l ls 34  not, '' u 1:6 every 4 w l ls 35 not,\
'ext.mode1.100.Ex.01.00.t1000ps.nve/set/metastable.out'		u 1:2 every 4 w l ls 41 not, '' u 1:3 every 4 w l ls 42 not, '' u 1:4 every 4 w l ls 43  not, '' u 1:5 every 4 w l ls 44  not, '' u 1:6 every 4 w l ls 45 not
...
pl \
'lines' w l ls 20 not,\
'ext.mode1.010.Ex.01.00.t0600ps/set/metastable.out'		u 1:2 every 8 w l ls 11 t 'NVT t_{init}=10 ps' , '' u 1:3 every 8 w l ls 12 not, '' u 1:4 every 8 w l ls 13  not, '' u 1:5 every 8 w l ls 14  not, '' u 1:6 every 8 w l ls 15 not,\
'ext.mode1.100.Ex.01.00.t1200ps/set/metastable.out'		u 1:2 every 8 w l ls 21 t 'NVT t_{init}=100 ps', '' u 1:3 every 8 w l ls 22 not, '' u 1:4 every 8 w l ls 23  not, '' u 1:5 every 8 w l ls 24  not, '' u 1:6 every 8 w l ls 25 not,\
'ext.mode1.010.Ex.01.00.t1000ps.nve/set/metastable.out'		u 1:2 every 8 w l ls 31 t 'NVE t_{init}=10 ps' , '' u 1:3 every 8 w l ls 32 not, '' u 1:4 every 8 w l ls 33  not, '' u 1:5 every 8 w l ls 34  not, '' u 1:6 every 8 w l ls 35 not,\
'ext.mode1.100.Ex.01.00.t1000ps.nve/set/metastable.out'		u 1:2 every 8 w l ls 41 t 'NVT t_{init}=100 ps', '' u 1:3 every 8 w l ls 42 not, '' u 1:4 every 8 w l ls 43  not, '' u 1:5 every 8 w l ls 44  not, '' u 1:6 every 8 w l ls 45 not
# pl \
...
# 'ext.mode1.010.Ex.01.00.t0600ps/set/metastable.out'		u 1:2 every 4 w l ls 11 t 't_{init}=10 ps', '' u 1:3 every 4 w l ls 12 not, '' u 1:4 every 4 w l ls 13  not, '' u 1:5 every 4 w l ls 14  not, '' u 1:6 every 4 w l ls 15 not,\
...
# 'ext.mode1.100.Ex.01.00.t1200ps/set/metastable.out'		u 1:2 every 4 w l ls 31 t 't_{init}=100 ps', '' u 1:3 every 4 w l ls 32 not, '' u 1:4 every 4 w l ls 33  not, '' u 1:5 every 4 w l ls 34  not, '' u 1:6 every 4 w l ls 35 not
