...
\recheck{As a matter fact, if $\hat X_m$ is Markovian, we prove the identity of the transition matrices: $\hat P = \hat T \hat M^{-1}$ (see~Appendix~\ref{sec:app-ptm} for detail).
...
Notice that in the fifth equation we assumes the Markovianity of the milestone process $\hat X_m$.
