...
the transition probabilities are sampled from MD trajectories, and
the MSM does not need more information from the MD simulation.
The quality of the MSM therefore relies on the quality of the discretizations.
...
\begin{figure}
  \centering
  \includegraphics[width=0.6\textwidth]{fig/t010/cluster.marco.3/fig-cluster.eps}
