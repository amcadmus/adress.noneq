...
\begin{tocentry}
\includegraphics[height=3.6cm]{toc.eps}
\end{tocentry}
...
%The  lower accuracy is due to the fact that
%the corresponding timescale of 26.5~ps (calculated by $-T/\log(\lambda_2)$) is \emph{not} significantly longer than the temporal resolution given by the period $T=10$~ps of the external driving force:
%%%CS
\begin{figure}
  \centering
  \includegraphics[width=0.45\textwidth]{hitting.eps}
