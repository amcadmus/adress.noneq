...
'zm.l2.alpha0.00.rc1.2.long/nvt/gkr.out' u 1:2 w l ls 162 t '{/Symbol a} = 0.0 nm^{-1}',\
'zm.l2.alpha0.50.rc1.2.long/nvt/gkr.out' u 1:2 w l ls 122 t '{/Symbol a} = 0.5 nm^{-1}',\
'zm.l2.alpha1.00.rc1.2.long/nvt/gkr.out' u 1:2 w l ls 132 t '{/Symbol a} = 1.0 nm^{-1}',\
'zm.l2.alpha1.50.rc1.2.long/nvt/gkr.out' u 1:2 w l ls 142 t '{/Symbol a} = 1.5 nm^{-1}',\
'zm.l2.alpha2.00.rc1.2.long/nvt/gkr.out' u 1:2 w l ls 152 t '{/Symbol a} = 2.0 nm^{-1}',\
'spme.tune.nvt.smooth.20ns/nvt/gkr.out'  u 1:2:($2-2*$3):($2+2*$3) every 15 w e ls 112 not,\
'' u 1:2 w l ls 112 not 'SPME',\
'zm.l2.alpha0.00.rc1.2.long/nvt/gkr.out' u 1:2:($2-2*$3):($2+2*$3) every 15 w e ls 162 not,\
