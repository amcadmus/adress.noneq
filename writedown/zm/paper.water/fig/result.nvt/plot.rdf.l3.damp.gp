...
pl 1 lc 0 lw 2 not,\
   ...
   'zm.l3.alpha0.00.rc1.2.long/nvt/rdf.xvg' u 1:2 w l ls 162 t '{/Symbol a} = 0.0 nm^{-1}',\
   'zm.l3.alpha0.50.rc1.2.long/nvt/rdf.0.002.xvg' u 1:2 w l ls 122 t '{/Symbol a} = 0.5 nm^{-1}',\
   'zm.l3.alpha1.00.rc1.2.long/nvt/rdf.0.002.xvg' u 1:2 w l ls 132 t '{/Symbol a} = 1.0 nm^{-1}',\
   'zm.l3.alpha1.50.rc1.2.long/nvt/rdf.0.002.xvg' u 1:2 w l ls 142 t '{/Symbol a} = 1.5 nm^{-1}',\
   'zm.l3.alpha2.00.rc1.2.long/nvt/rdf.0.002.xvg' u 1:2 w l ls 152 t '{/Symbol a} = 2.0 nm^{-1}',\
...
pl 1 lc 0 lw 2 not,\
   ...
   'zm.l3.alpha0.00.rc1.2.long/nvt/rdf.0.01.xvg' u 1:2 w l ls 162 not '{/Symbol a} = 0.0 nm^{-1}',\
   'zm.l3.alpha0.50.rc1.2.long/nvt/rdf.0.01.xvg' u 1:2 w l ls 122 not '{/Symbol a} = 0.0 nm^{-1}',\
   'zm.l3.alpha1.00.rc1.2.long/nvt/rdf.0.01.xvg' u 1:2 w l ls 132 not '{/Symbol a} = 0.0 nm^{-1}',\
   'zm.l3.alpha1.50.rc1.2.long/nvt/rdf.0.01.xvg' u 1:2 w l ls 142 not '{/Symbol a} = 0.0 nm^{-1}',\
   'zm.l3.alpha2.00.rc1.2.long/nvt/rdf.0.01.xvg' u 1:2 w l ls 152 not '{/Symbol a} = 0.0 nm^{-1}',\
   'spme.tune.nvt.smooth.20ns/nvt/rdf.0.01.xvg' u 1:2 every 1 w l ls 112 not 'SPME',\
   'plot.rdf.box' u 1:2 index 2 w l lc 0 lw 3 not
