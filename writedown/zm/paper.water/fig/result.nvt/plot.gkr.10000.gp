...
pl \
'spme.tune.nvt.smooth.20ns/nvt/gkr.10000.out' u 1:2 w l ls 112 t 'SPME',\
'rf.rc1.2.long/nvt/gkr.10000.out' u 1:2 w l ls 162 t 'RF',\
'zm.l1.alpha0.00.rc1.2.long/nvt/gkr.10000.out' u 1:2 w l ls 122 t 'ZM l = 1',\
'zm.l2.alpha0.00.rc1.2.long/nvt/gkr.10000.out' u 1:2 w l ls 132 t 'ZM l = 2',\
'zm.l3.alpha0.00.rc1.2.long/nvt/gkr.10000.out' u 1:2 w l ls 142 t 'ZM l = 3',\
'zm.l4.alpha0.00.rc1.2.long/nvt/gkr.10000.out' u 1:2 w l ls 152 t 'ZM l = 4',\
'spme.tune.nvt.smooth.20ns/nvt/gkr.10000.out' u 1:2:($2-2*$3):($2+2*$3) every 15 w e ls 112 not,\
'' u 1:2 w l ls 112 not 'SPME',\
'zoom.box'  w l lc 0 lw 3 not

# 'zm.l4.alpha0.00.rc1.2.long/nvt/gkr.10000.out' u 1:2:($2-2*$3):($2+2*$3) every 15 w e ls 152 not,\
...
# 'zm.l3.alpha0.00.rc1.2.long/nvt/gkr.10000.out' u 1:2 w l ls 142 t 'ZM l = 3',\
# 'zm.l4.alpha0.00.rc1.2.long/nvt/gkr.10000.out' u 1:2 w l ls 152 t 'ZM l = 4',\
# 'spme.tune.20ns/nvt/gkr.10000.out' u 1:2:($2-2*$3):($2+2*$3) every 16 w e ls 112 not,\
# '' u 1:2 w l ls 112 t 'SPME'



# pl \
# 'spme.tune.20ns/nvt/gkr.10000.out' u 1:($2-2*$3):($2+2*$3) w filledcu ls 111 not,\
# '' u 1:2 w l ls 112 not,\
# 'zm.l1.alpha0.00.rc1.2.long/nvt/gkr.10000.out' u 1:($2-2*$3):($2+2*$3) w filledcu ls 121 not,\
