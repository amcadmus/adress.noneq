...
pl 1 lc 0 lw 2 not,\
   'rdf.all.out' u 1:3 every 5 w l ls 112 t 'SPME',\
   '' u 1:2 w l ls 162 t 'RF',\
   '' u 1:4 w l ls 122 t 'ZM l = 1',\
   '' u 1:5 w l ls 132 t 'ZM l = 2',\
   '' u 1:6 w l ls 142 t 'ZM l = 3',\
   '' u 1:7 w l ls 152 t 'ZM l = 4',\
   'rdf.all.out' u 1:3 every 5 w l ls 112 not 'SPME',\
...
pl 1 lc 0 lw 2 not,\
   ...
   'rdf.all.0.01.out' u 1:2 w l ls 162 not 'RF',\
   '' u 1:4 w l ls 122 not 'ZM l = 1',\
   '' u 1:5 w l ls 132 not 'ZM l = 2',\
   '' u 1:6 w l ls 142 not 'ZM l = 3',\
   '' u 1:7 w l ls 152 not 'ZM l = 4',\
   'rdf.all.0.01.out' u 1:3 w l ls 112 not 'SPME'
