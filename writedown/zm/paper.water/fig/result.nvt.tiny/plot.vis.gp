...
'rf.rc1.2/nvt/viscosity.out' u 1:2 w l ls 162 t 'RF',\
'zm.l1.alpha0.00.rc1.2/nvt/viscosity.out' u 1:2 w l ls 122 t 'ZM l = 1',\
'zm.l2.alpha0.00.rc1.2/nvt/viscosity.out' u 1:2 w l ls 132 t 'ZM l = 2',\
'zm.l3.alpha0.00.rc1.2/nvt/viscosity.out' u 1:2 w l ls 142 t 'ZM l = 3',\
'zm.l4.alpha0.00.rc1.2/nvt/viscosity.out' u 1:2 w l ls 152 t 'ZM l = 4',\
