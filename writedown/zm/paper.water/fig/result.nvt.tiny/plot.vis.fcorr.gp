...
'zm.l1.alpha0.00.rc1.2.fcorr/nvt/viscosity.out' u 1:2 w l ls 132 t 'ZM l = 1 F.corr',\
...
'zm.l1.alpha0.00.rc1.2.fcorr/nvt/viscosity.out' u 1:2:($2-2*$3):($2+2*$3) every 150 w e ls 132 not
