...
set yrange [0:120]
# pl \
# 'spme.tune.nvt.smooth.20ns/nvt/eps.3000.xvg'   u 1:2 w l ls 112 t 'SPME',\
# 'spme.tune.nvt.smooth.20ns/nvt/eps.10000.xvg'  u 1:2 w l ls 112 not,\
...
pl \
'spme.40ns/nvt/eps.3000.xvg'   u 1:2 w l ls 112 t 'SPME',\
'rf.rc1.2/nvt/eps.3000.xvg'  u 1:2 w l ls 162 t 'RF',\
'zm.l1.alpha0.00.rc1.2/nvt/eps.3000.xvg'  u 1:2 w l ls 122 t 'ZM l=1',\
'zm.l2.alpha0.00.rc1.2/nvt/eps.3000.xvg'  u 1:2 w l ls 132 t 'ZM l=2',\
'zm.l3.alpha0.00.rc1.2/nvt/eps.3000.xvg'  u 1:2 w l ls 142 t 'ZM l=3',\
'zm.l4.alpha0.00.rc1.2/nvt/eps.3000.xvg'  u 1:2 w l ls 152 t 'ZM l=4'
