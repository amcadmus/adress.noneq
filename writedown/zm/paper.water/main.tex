...
was applied in the cases of RF simulations. We used $1.2$~nm cut-off and the
...
calculation, please state around here or elsewhere.] }
...
when using increasingly large cut-off radius. {\color{red} In Fig.~\ref%
...
Kirkwood-G factor than smaller splitting parameters.[} {\color{blue} OK}]
