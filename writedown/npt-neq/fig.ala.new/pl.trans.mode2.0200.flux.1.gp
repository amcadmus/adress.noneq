...
set out 'fig-trans-mode2-0200-flux-1.eps'
...
pl 'ext.mode2.200.Ex.01.00.shift0.t1600ps/set/meta.flux.out' u 1:2 ls 11 w l not, '' u 1:3 ls 12 w l not, '' u 1:4 ls 13 w l not, '' u 1:5 ls 14 w l not, '' u 1:6 ls 15 w l not
