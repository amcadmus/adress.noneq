...
pl 'ext.mode2.010.Ex.01.00.shift0.t1000ps/set/meta.flux.inte.out' u 1:($22*1) ls 11 w l not, '' u 1:($23*1) ls 12 w l not, '' u 1:($24*1) ls 13 w l not, '' u 1:($25*1) ls 14 w l not, '' u 1:($26*1) ls 15 w l not
