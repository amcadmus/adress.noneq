...
set mxtics 5
set xlabel 't [ ps ]'
set ylabel 'Orientational order parameter'
set rmargin 8
...
set xrange [0:100]
pl \
'ext.mode1.010.Ex.01.00.t1000ps/set/two.vectors.out' u 1:7 w l ls 20 not 'const. field t_{init} = 10 ps', \
'ext.mode2.010.Ex.01.00.shift0.t1000ps/set/two.vectors.out' u 1:7 w l ls 11 not 'T = 10 ps', \
'ext.mode2.040.Ex.01.00.shift0.t1000ps/set/two.vectors.out' u 1:7 w l ls 12 not 'T = 40 ps', \
'ext.mode2.200.Ex.01.00.shift0.t6400ps/set/two.vectors.out' u 1:7 w l ls 13 not 'T =100 ps'
...
set label 't [ ps ]' at 200, -0.3
set label '(b)' at -580,0.6 font "Helvetica,30"
set xrange [100:1000]
rep