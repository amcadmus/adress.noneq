set label "Q_{J,{/Symbol a}'_R}, T_P = 10 ps" at 50,1.0
set lmargin 4.5
set rmargin 2
unset tmargin
unset bmargin
...
set out 'fig-trans-mode2-0010-iflux-2.eps'
...
pl 'ext.mode2.010.Ex.01.00.shift0.t1000ps/set/meta.flux.inte.out' u 1:($7*1) ls 11 w l not, '' u 1:($8*1) ls 12 w l not, '' u 1:($9*1) ls 13 w l not, '' u 1:($10*1) ls 14 w l not, '' u 1:($11*1) ls 15 w l not
