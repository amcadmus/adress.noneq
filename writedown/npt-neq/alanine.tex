...
proteins gains increasing attention recently, because it closely
...
complete understanding of how the electric field influence the  protein
...
in both static and oscillatory electric
...
secondary structure is changed by external electric field.  However,
...
electric field, and the dynamics under oscillating electric field.
...
simulations.  This provides a promising way of analyzing the
...
changes, when do these changes happens, and how strong are the changes.
...
The aforementioned nonequilibrium molecular dynamics simulation algorithm
...
\begin{figure}
  \centering
  \includegraphics[width=0.5\textwidth]{fig.ala/graphs/graph-t0010.eps}
