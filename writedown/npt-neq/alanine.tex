...
\bluec{
  ...
  \textit{NOTE: we should mention that the local thermostat works...}
}
...
We plot the net probability fluxes integration in Fig.~\ref{fig:tmp6}.
...
\bluec{Comparing Fig.~\ref{fig:tmp3} with~\ref{fig:tmp5},
...
\recheck{In fact,
  \bluec{the vector of the geometric direction tends to be perpendicular
...
0.25 for $T=200$~ps.
\bluec{
In the case of $T=10$ and $40$~ps, {the probability of conformation $C$}
reaches the steady value in around 300~ps, while it requires about 1200~ps
for the $T=200$~ps case. } \bluec{\textit{Here I do not agree with you to remove the above blue discussion,
