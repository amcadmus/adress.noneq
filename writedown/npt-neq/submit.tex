...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\documentclass[journal=jctcce,manuscript=manuscript]{achemso}
...
\affiliation{Institute for Mathematics, Freie Universit\"at Berlin, Germany}
\alsoaffiliation{Zuse Institute Berlin, Germany}
...
\alsoaffiliation{Dipartimento di Fisica, Universit\`a ``La Sapienza'' and CNISM, Piazzale Aldo Moro 5, 00185 Roma, Italy}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{tocentry}
\includegraphics[height=3.6cm]{final-3.eps}
...
% {The use of leap-frog scheme and Parrinello-Rahman barostat
...
\begin{figure}
  \centering
  \includegraphics[]{fig-meta-more.eps}
...
\begin{figure}
  \centering
  \includegraphics[width=0.22\textwidth]{fig-trans-010-flux-1.eps}
  \includegraphics[width=0.22\textwidth]{fig-trans-010-flux-2.eps}\\
  \vskip .3cm
  \includegraphics[width=0.22\textwidth]{fig-trans-010-flux-3.eps}
  \includegraphics[width=0.22\textwidth]{fig-trans-010-flux-4.eps}\\
  \vskip .3cm
  \includegraphics[width=0.22\textwidth]{fig-trans-010-flux-5.eps}
  \caption{
    ...
    From top to bottom, left to right we report $I = \confaa$, $\confab$, $\confba$, $\confbb$ and
    ...
    for $J=\confc$.
    {This plot is drawn from the four-branching-trajectories case (see the text).}
    }
  \label{fig:tmp6}
\end{figure}
...
{fade away as the system relaxes}. The
probability of the $\alpha$-helix conformation $\confaa$, grows from 0.43 to 0.65.
The $\alpha$-helix $\confab$  does not change significantly  under the action of EF.
The left-hand helix conformation $\confc$ noticeably grows from 0.05 to 0.25.
We plot the net probability fluxes {of the four-branching-trajectories case} in Fig.~\ref{fig:tmp6}.
...
\begin{figure}
  \centering
  \includegraphics[width=0.4\textwidth]{fig-rdf.eps}
  \includegraphics[width=0.4\textwidth]{fig-hbond.eps}
...
\begin{figure}
  \centering
  \includegraphics[width=0.4\textwidth]{fig-mode2-dipol.eps}
  \includegraphics[width=0.4\textwidth]{fig-mode2-order.eps}
...
\begin{figure}
  \centering
  \includegraphics{fig-corr-meta.eps}
  \includegraphics{fig-corr-meta-c.eps}
  \caption{
