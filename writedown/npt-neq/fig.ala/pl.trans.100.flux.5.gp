...
set out 'fig-trans-100-flux-5.eps'
set multiplot
set size 0.4,1
unset yrange
set mytics 2
...
set mxtics 5
set xrange [0:100]
pl 'ext.mode1.100.Ex.01.00.t1200ps/set/meta.flux.out' u 1:22 ls 11 w l not, '' u 1:23 ls 12 w l not, '' u 1:24 ls 13 w l not, '' u 1:25 ls 14 w l not, '' u 1:26 ls 15 w l not
set label 'P_{J,C}'  at 450,0.7
set size 0.6,1
set origin 0.4,0.0
set lmargin 0
set rmargin 2
