...
set out 'fig-trans-010-bwd-5.eps'
set multiplot
set size 0.4,1
set yrange [0:1]
set mytics 2
...
set mxtics 5
set xrange [0:100]
pl 'ext.mode1.010.Ex.01.00.t0600ps/set/meta.corr.bw.out' u 1:22 ls 11 w l not, '' u 1:23 ls 12 w l not, '' u 1:24 ls 13 w l not, '' u 1:25 ls 14 w l not, '' u 1:26 ls 15 w l not
