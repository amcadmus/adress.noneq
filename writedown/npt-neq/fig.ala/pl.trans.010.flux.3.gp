...
set mxtics 5
set xrange [0:100]
pl 'ext.mode1.010.Ex.01.00.t0600ps/set/meta.flux.smooth.out' u 1:12 ls 11 w l not, '' u 1:13 ls 12 w l not, '' u 1:14 ls 13 w l not, '' u 1:15 ls 14 w l not, '' u 1:16 ls 15 w l not
