...
pl 'ext.mode2.010.Ex.01.00.shift0.t1000ps/set/meta.flux.inte.out' u 1:($17*2) ls 11 w l not, '' u 1:($18*2) ls 12 w l not, '' u 1:($19*2) ls 13 w l not, '' u 1:($20*2) ls 14 w l not, '' u 1:($21*2) ls 15 w l not
