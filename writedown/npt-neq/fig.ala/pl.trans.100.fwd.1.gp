...
set out 'fig-trans-100-fwd-1.eps'
set multiplot
set size 0.4,1
set yrange [0:1]
set mytics 2
...
set mxtics 5
set xrange [0:100]
pl 'ext.mode1.100.Ex.01.00.t1200ps/set/meta.corr.fw.out' u 1:2 ls 11 w l not, '' u 1:3 ls 12 w l not, '' u 1:4 ls 13 w l not, '' u 1:5 ls 14 w l not, '' u 1:6 ls 15 w l not
set label 'P@^{fwd}_{J,A_1}'  at 450,0.78
set size 0.6,1
set origin 0.4,0.0
set lmargin 0
set rmargin 2
