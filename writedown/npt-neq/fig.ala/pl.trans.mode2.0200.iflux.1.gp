set label 'Q_{J,A_1}, T = 200 ps' at 200,0.2
set lmargin 4.5
set rmargin 2
unset tmargin
unset bmargin
...
pl 'ext.mode2.200.Ex.01.00.shift0.t3200ps/set/meta.flux.inte.out' u 1:2 ls 11 w l not, '' u 1:3 ls 12 w l not, '' u 1:4 ls 13 w l not, '' u 1:5 ls 14 w l not, '' u 1:6 ls 15 w l not
