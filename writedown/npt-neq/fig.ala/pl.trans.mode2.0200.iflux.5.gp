set label 'Q_{J,C}, T = 200 ps' at 200,0.25
set lmargin 4.5
set rmargin 2
unset tmargin
unset bmargin
...
pl 'ext.mode2.200.Ex.01.00.shift0.t3200ps/set/meta.flux.inte.out' u 1:22 ls 11 w l not, '' u 1:23 ls 12 w l not, '' u 1:24 ls 13 w l not, '' u 1:25 ls 14 w l not, '' u 1:26 ls 15 w l not
